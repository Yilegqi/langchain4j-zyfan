...
- **工作区路径**: `/Users/yilakeqi/Project/IDEAProject/solo_practice/ai_practice/langchain4j-zyfan`
...
- **主框架**: Spring Boot 3.3.8
- **语言版本**: Java 17.0.7
- **核心依赖**:
  - `spring-boot-starter-web`
  - `spring-boot-starter-data-jpa` (虽然未直接列出，但可能需要根据业务需求添加)
  - `lombok`
...
- 使用 `spring-boot-dependencies` 管理 Spring Boot 相关依赖。
- 使用 `langchain4j-bom` 管理 LangChain4j 相关依赖。
- `lombok` 作为编译时依赖，用于简化实体类的 getter/setter 和构造方法。
- `langchain4j-open-ai-spring-boot-starter` 用于集成 OpenAI 的协议标准。
